...
@section('content')
    ...
    <div class="headcrumbs d-flex mb-3">
        <a href="{{ route('services.index') }}" class="d-flex text-uppercase me-2" style="opacity:25%">Services</a> >> <a class="d-flex text-uppercase ms-2">Add</a>
    </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-lg-6 col-sm-6">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <input type="text" id="title" class="form-control" name="title[{{ $language->small }}]" placeholder="title" value="{{ old('title.'.$language->small) }}">
                                            </div>
                                            <!-- End of Form -->
                                        </div>
                                    </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-lg-6 col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="img" type="file" placeholder="img" name="img">
                                </div>
                            </div>
                        </div>
...
@section('scripts')
    <script>
        $('#add_option').click(function() {
            $('.options_block').append('<input type="text" class="form-control mt-2" name="options[{{ $language->small }}][]" placeholder="options">');
        });
    </script>
@endsection
